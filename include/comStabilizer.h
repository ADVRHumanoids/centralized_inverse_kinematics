#ifndef FULLSTABILIZER_H
#define FULLSTABILIZER_H
#include <cmath>
#include <vector>
#include <Eigen/Dense>
#include <iostream>
...
class fullStabilizer
{
public:

    fullStabilizer();
    ~fullStabilizer();
    fullStabilizer(double LQRgains[2],double sampleTime,std::string FILEG,std::string FILEH,std::string FILEF);
    /**
